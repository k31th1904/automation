...
output "linux_vm_name" {
  value = module.vmlinux-n01595368.vm_name
}
output "linux_vm_fqdn" {
  value = module.vmlinux-n01595368.vm_fqdn
}
output "linux_vm_privateIP" {
  value = module.vmlinux-n01595368.vm_privateIP
}
output "linux_vm_publicIP" {
  value = module.vmlinux-n01595368.vm_publicIP
}
